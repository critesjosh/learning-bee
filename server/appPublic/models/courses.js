...
class Courses {
    ...
    getAll() {
        ...
        return new Promise((resolve, reject) => {
            ...
            const coursesModelSearchObject = {
                include: [
                    {
                        model: this.definitions.Video,
                        as: 'videos',
                        include: [
                            {
            ...
            this.definitions.Course.findAll(coursesModelSearchObject).then(courses => {

                /**
                 * A new constant resObj is declared where only specific attributes are mapped from the model.
                 */

                const resObj = courses.map(course => {
